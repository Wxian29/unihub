"""
Django settings for uni_hub_core project.
"""
...
ROOT_URLCONF = 'uni_hub_core.urls'
...
WSGI_APPLICATION = 'uni_hub_core.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('DB_NAME', default='uni_hub'),
